...
export const webRoutes = [
  ...
  { method: "GET", path: "/playlist/{id}/delete", config: playlistController.deletePlaylist },
  { method: "GET", path: "/playlist/{id}/track/{trackid}/delete", config: playlistController.deleteTrack },
